...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF9F9] relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col md:flex-row items-center justify-between px-8 md:px-16 lg:px-24">
        {/* Left Section: Logo, Text, and Button */}
        <div className="w-full max-w-md space-y-8 ml-32">
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              <ClipboardList className="text-[#7B1984] text-xl font-bold" />
              <h1 className="text-xl font-bold text-[#7B1984]">TaskBuddy</h1>
            </div>
            <p className="text-xs font-semibold text-gray-600 max-w-[310px]">
          ...
          <button
            ...
            className=" flex items-center justify-center space-x-3 bg-gray-900 text-white rounded-xl px-16 py-3 hover:bg-gray-800 transition-colors"
          >
